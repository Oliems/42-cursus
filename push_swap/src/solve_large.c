...
/*   Updated: 2023/01/26 18:00:41 by mbarberi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
+ Phase 1
    + Divide the maximum index by 3 (3 slices for n = 100, 6 slices for n =
      500).
    + Push the two smallest parts onto stack B. For example if we have 100
      numbers, we need to push numbers with indexes 1 to 66 to B. If the
      number's index belongs to the first part (in the previous example if
